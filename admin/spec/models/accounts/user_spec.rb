...
describe User do
  ...
  describe '#shipments' do
    ...
    let(:association_class) { Shipment }
  ...
  describe '#ownerships' do
    ...
    let(:association_class) { Ownership }
  ...
  describe 'transactions' do
    ...
    let(:association_class) { Transaction }
  ...
  describe '#purchases' do
    ...
    let(:association_class) { Purchase }
  ...
  describe '#create_payment_method' do
    ...
    let(:association_class) { PaymentMethod }
